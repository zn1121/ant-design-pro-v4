import { Alert, Checkbox } from 'antd';//Icon
...
const { Tab, UserName, Password,  Submit } = LoginComponents;//Mobile, Captcha,
    ...
    return (
      ...
      <div className={styles.main}>
        ...
        >
          ...
          <div>
            <Checkbox checked={autoLogin} onChange={this.changeAutoLogin} style={{ float: 'right' }}>
